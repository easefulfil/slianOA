...
function DrawCharts(ec) {
	if($.string.isNullOrEmpty($('.counterman').combobox('getValues').toString())){
		alert("请选择销售。");
		return false;
	}
	drawQueryTimes(ec);
...
function getChartData(myChart) {
	...
	$.ajax({
				type : 'POST',
				async : false,
				url : getContextPath()+'/factscreen/getcountermanquerytimesformanager.do',
				data : {
...
function getChartData1(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url : getContextPath()+'/factscreen/getcountermansendtimesformanager.do',
		data : {
			startdate : $("#startdate").datebox("getValue"),
			enddate : $("#enddate").datebox("getValue"),
			countermanid : $(".counterman").combobox("getValues").join(',')
...
function getChartData2(myChart) {
	...
	$.ajax({
				type : 'POST',
				async : false,
				url : getContextPath()+'/factscreen/top10routeforMulCounterman.do',
				data : {
					startdate : $("#startdate").datebox("getValue"),
					enddate : $("#enddate").datebox("getValue"),
					topnum : $("#topnum").combobox("getValue"),
					countermanids : $(".counterman").combobox("getValues")
							.join(",")
				},
				dataType : 'json',
				success : function(result) {
...
function getChartData3(myChart) {
	...
	$.ajax({
				type : 'POST',
				async : false,
				url : getContextPath()+'/factscreen/top10dischargingportforMulCounterman.do',
				data : {
					startdate : $("#startdate").datebox("getValue"),
					enddate : $("#enddate").datebox("getValue"),
					topnum : $("#topnum").combobox("getValue"),
...
function getChartData4(myChart) {
	...
	$
			.ajax({
				type : 'POST',
				async : false,
				url : getContextPath()+'/factscreen/gethotcompanyformanageremployee.do',
				data : {
					startdate : $("#startdate").datebox("getValue"),
					enddate : $("#enddate").datebox("getValue"),
					topnum : $("#topnum").combobox("getValue"),
