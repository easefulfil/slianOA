...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/hotrouteforsinglecustomer.do',
...
//				alert("关注航线查询结果为空，请更换数据查询条件！");
	...
	function eConsole(param){
		...
		$.ajax({
			type : 'POST',
			async : false,
			url:getContextPath()+'/detail/routedetailofsa.do',
			data:{startdate:$("#startdate").datebox('getValue'),
					enddate:$("#enddate").datebox('getValue'),
					mes:mes},
			dataType:'json',
...
function getChartData1(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/hotdischargingportforsinglecustomer.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox("getValue"),
				customerid:$(".customer").combobox("getValue")},
...
//				alert("关注港口查询结果为空，请更换数据查询条件！");
	...
	function eConsole(param){
		...
		$.ajax({
			type : 'POST',
			async : false,
			url:getContextPath()+'/detail/portdetailofsa.do',
			data:{startdate:$("#startdate").datebox('getValue'),
					enddate:$("#enddate").datebox('getValue'),
					mes:mes},
			dataType:'json',
...
function getChartData2(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/querytimesforsinglecustomer.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				customerid:$(".customer").combobox("getValue")},
		dataType:'json',
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/gethotcompanyforcounterman.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox("getValue"),
				customerid:$(".customer").combobox("getValue")},
...
//				alert("关注航线查询结果为空，请更换数据查询条件！");
	...
	function eConsole(param){
		...
		$.ajax({
			type : 'POST',
			async : false,
			url:getContextPath()+'/detail/companydetailofsa.do',
			data:{startdate:$("#startdate").datebox('getValue'),
					enddate:$("#enddate").datebox('getValue'),
					mes:mes},
			dataType:'json',
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/getflowforcounterman.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox("getValue"),
				customerid:$(".customer").combobox("getValue")},
