...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/customerhotrouteforgmanager.do',
...
//				alert("关注航线查询结果为空，请更换数据查询条件！");
	...
	function eConsole(param){
		...
		$.ajax({
			type : 'POST',
			async : false,
			url:getContextPath()+'/detail/routedetailofgma.do',
			data:{startdate:$("#startdate").datebox('getValue'),
					enddate:$("#enddate").datebox('getValue'),
					departmentid:$("#department").combobox("getValue"),
					countermanid:$("#counterman").combobox("getValue"),
...
function getChartData1(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/customerhotdischargingportforgmanager.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
...
//				alert("关注港口查询结果为空，请更换数据查询条件！");
	...
	function eConsole(param){
		...
		$.ajax({
			type : 'POST',
			async : false,
			url:getContextPath()+'/detail/portdetailofgma.do',
			data:{startdate:$("#startdate").datebox('getValue'),
					enddate:$("#enddate").datebox('getValue'),
					departmentid:$("#department").combobox("getValue"),
					countermanid:$("#counterman").combobox("getValue"),
...
function getChartData2(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/customerquerytimesforgmanager.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				departmentid:$("#department").combobox("getValue"),
				countermanid:$("#counterman").combobox("getValue"),
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/getcompanyofgmanager.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
...
//				alert("关注航线查询结果为空，请更换数据查询条件！");
	...
	function eConsole(param){
		...
		$.ajax({
			type : 'POST',
			async : false,
			url:getContextPath()+'/detail/companydetailofgma.do',
			data:{startdate:$("#startdate").datebox('getValue'),
					enddate:$("#enddate").datebox('getValue'),
					departmentid:$("#department").combobox("getValue"),
					countermanid:$("#counterman").combobox("getValue"),
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/getflowofgmanager.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
