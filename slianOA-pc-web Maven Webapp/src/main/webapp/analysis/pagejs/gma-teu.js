...
function getChartData(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/TeuActiveDepartmentForGManager.do',
...
function getChartData1(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/TeuActiveEmployeeForGManager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
...
function getChartData2(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/TeuActiveCustomerForGManager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/TeuRouteForGManager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
...
function getChartData4(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/TeuDischargingPortForGManager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url:getContextPath()+'/factscreen/TeuCompanyForGManager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
				departmentid:$("#department").combobox("getValue"),
