...
function getChartData(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/getteuactiveemployeeofmanager.do',
...
function getChartData1(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/getteuactivecustomerofmanager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/getteurouteofmanager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				countermanid:$(".counterman").combobox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
...
function getChartData3(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/getteudischargingportofmanager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				countermanid:$(".counterman").combobox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
...
function getChartData4(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/getteucompanyofmanager.do',
		data:{startdate:$("#startdate").datebox("getValue"),
				enddate:$("#enddate").datebox("getValue"),
				countermanid:$(".counterman").combobox("getValue"),
				topnum:$("#topnum").combobox("getValue"),
