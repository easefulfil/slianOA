...
//	var options = myChart.getOption();
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/teurouteofcounterman.do',
...
function getChartData1(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/teudischargingportofcounterman.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox('getValue'),
				customerid: $(".customer").combobox('getValue')},
...
function getChartData2(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/teuactivecustomerofcounterman.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox('getValue')},
		dataType:'json',
...
function getChartData3(myChart) {
	...
	$.ajax({
		type : 'POST',
		async : false,
		url: getContextPath()+'/factscreen/teucompanyofcounterman.do',
		data:{startdate:$("#startdate").datebox('getValue'),
				enddate:$("#enddate").datebox('getValue'),
				topnum:$("#topnum").combobox('getValue'),
				customerid: $(".customer").combobox('getValue')},
